...
const offerings = [
  {
    ...
    description: "Real-time dashboards with drill-down capabilities and customizable visualizations.",
  },
  {
    icon: PieChart,
    title: "Advanced Analytics",
    description: "Statistical analysis, predictive modeling, and machine learning insights.",
  },
  {
    icon: TrendingUp,
    title: "Business Intelligence",
    description: "KPI tracking, performance metrics, and strategic business insights.",
  },
  {
    icon: Database,
    title: "Data Integration",
    description: "Seamless integration of multiple data sources and real-time data processing.",
  },
  {
    icon: Eye,
    title: "Data Visualization",
    description: "Compelling charts, graphs, and visual storytelling for complex data sets.",
  },
  {
    icon: Brain,
    title: "AI-Powered Insights",
    description: "Automated pattern recognition and intelligent recommendations.",
  },
]
...
const engagementSteps = [
  {
    ...
    description: "Comprehensive analysis of your data sources, quality, and business requirements",
    duration: "1-2 weeks",
    icon: Target,
  ...
  },
  {
    ...
    description: "Data pipeline design, visualization strategy, and technology stack selection",
    duration: "2-3 weeks",
    icon: Database,
  ...
  },
  {
    step: "03",
    title: "Development",
    description: "Building data pipelines, creating visualizations, and implementing analytics",
    duration: "6-12 weeks",
    icon: BarChart3,
  ...
  },
  {
    ...
    description: "Data accuracy validation, performance testing, and user acceptance testing",
    duration: "2-3 weeks",
    icon: CheckCircle,
  ...
  },
  {
    ...
    description: "Production deployment, user training, and ongoing support setup",
    duration: "1-2 weeks",
    icon: TrendingUp,
...
const successStories = [
  {
    ...
    challenge: "Fragmented data across 500+ stores with no unified reporting",
    ...
    results: [
      ...
      { metric: "25%", label: "Sales Increase" },
  ...
  },
  {
    ...
    challenge: "Complex patient data analysis and operational efficiency tracking",
    solution: "Comprehensive BI platform with patient flow analytics and resource optimization",
    results: [
...
export default function DataAnalyticsVisualizationPage() {
  ...
  const mainText = "Data That Tells Stories"
  const subText =
    "We transform complex data into compelling visual narratives that drive informed decision-making and unlock hidden business insights."
  ...
  const getWordColor = (word: string, wordIndex: number, isMain = false) => {
    const isKeyword =
      word.includes("Data") ||
      word.includes("Stories") ||
      word.includes("insights") ||
      word.includes("decision-making") ||
      word.includes("visual")
    const opacity = getWordOpacity(wordIndex)

    if (isMain && (word.includes("Data") || word.includes("Stories"))) {
      return opacity > 0.5
    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="relative py-20 min-h-[80vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-blue-900/90 via-cyan-800/80 to-teal-900/90"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive data analytics and visualization services that turn raw data into strategic business
              advantages
            </p>
          </div>
      ...
      <section className="py-24 bg-gradient-to-br from-black via-gray-950 to-black relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              From data discovery to actionable insights, we transform your data into a strategic asset
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Real results from our data analytics projects that transformed business intelligence
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-slate-900 via-gray-900 to-slate-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Let's transform your data into actionable insights that drive strategic business decisions.
          </p>
