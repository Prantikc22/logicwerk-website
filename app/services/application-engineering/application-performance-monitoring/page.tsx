...
import { ArrowRight, Activity, BarChart3, AlertTriangle, Zap, Eye, TrendingUp, Lock, Clock, Target } from "lucide-react"
...
const offerings = [
  {
    ...
    description: "24/7 application performance monitoring with instant alerts and notifications.",
  },
  {
    icon: BarChart3,
    title: "Performance Analytics",
    description: "Comprehensive performance metrics, trends analysis, and capacity planning.",
  },
  {
    icon: AlertTriangle,
    title: "Proactive Alerting",
    description: "Intelligent alerting system that identifies issues before they impact users.",
  },
  {
    icon: Zap,
    title: "Performance Optimization",
    description: "Continuous performance tuning and optimization recommendations.",
  },
  {
    icon: Eye,
    title: "User Experience Monitoring",
    description: "End-user experience tracking and synthetic transaction monitoring.",
  },
  {
    icon: TrendingUp,
    title: "Scalability Planning",
    description: "Capacity planning and scalability recommendations based on performance data.",
  },
]
...
const engagementSteps = [
  {
    ...
    description: "Current performance assessment and monitoring strategy development",
    duration: "1-2 weeks",
    icon: Target,
  ...
  {
    step: "02",
    title: "Tool Setup & Configuration",
    description: "Monitoring tools installation, configuration, and baseline establishment",
    duration: "2-3 weeks",
    icon: Activity,
  ...
  },
  {
    ...
    description: "Full monitoring deployment with custom dashboards and alerting rules",
    duration: "3-4 weeks",
    icon: BarChart3,
  ...
  },
  {
    ...
    description: "Performance analysis, optimization recommendations, and implementation",
    duration: "2-4 weeks",
    icon: Zap,
  ...
  },
  {
    ...
    description: "Continuous monitoring, reporting, and performance optimization",
    duration: "Ongoing",
    icon: TrendingUp,
...
const successStories = [
  {
    ...
    challenge: "Slow page load times and frequent downtime during peak traffic periods",
    solution: "Implemented comprehensive APM solution with real-time monitoring and optimization",
    results: [
      { metric: "75%", label: "Faster Page Load Times" },
      { metric: "99.9%", label: "Uptime Achievement" },
      { metric: "50%", label: "Reduced Infrastructure Costs" },
    ],
  ...
  },
  {
    ...
    challenge: "Need for real-time monitoring of critical banking applications",
    solution: "Deployed enterprise APM with custom dashboards and proactive alerting",
    results: [
      { metric: "90%", label: "Faster Issue Resolution" },
      { metric: "Zero", label: "Unplanned Downtime" },
      { metric: "40%", label: "Improved User Satisfaction" },
    ],
    image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=400&fit=crop&crop=center",
  },
]

export default function ApplicationPerformanceMonitoringPage() {
  ...
  const mainText = "Performance That Scales"
  const subText =
    "We monitor, analyze, and optimize your applications to ensure peak performance, reliability, and exceptional user experiences at any scale."
  ...
  const getWordColor = (word: string, wordIndex: number, isMain = false) => {
    const isKeyword =
      ...
      word.includes("Scales") ||
      word.includes("monitor") ||
      word.includes("optimize") ||
      word.includes("reliability")
    const opacity = getWordOpacity(wordIndex)

    if (isMain && (word.includes("Performance") || word.includes("Scales"))) {
      return opacity > 0.5
      ...
      <section className="relative py-20 min-h-[80vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            ...
            alt="Application Performance Monitoring Background"
            className="w-full h-full object-cover"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-orange-900/90 via-red-800/80 to-purple-900/90"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive application performance monitoring solutions that provide deep insights into your
      ...
      <section className="py-24 bg-gradient-to-br from-black via-gray-950 to-black relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              A systematic approach to implementing comprehensive application performance monitoring
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Real results from our APM implementations that transformed application performance
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-slate-900 via-gray-900 to-slate-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Let's implement comprehensive monitoring solutions that ensure your applications perform at their best.
          </p>
